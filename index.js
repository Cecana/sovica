...
`
Question #1:
Did eSova met your expectations?
`,
`
Question #2:
Was CodeCombat useful?
`,
`
...
`
Question #4:
Do you utilize other online resources to learn to code?
`,
`
Question #5:
    ...
    return yo`
      <div class="${css.quiz}">
        <div class="${css.welcome}">
          <img src= " http://www.esova.rs/wp-content/uploads/2016/03/logo-esova-s.png "> quiz!
        </div>
